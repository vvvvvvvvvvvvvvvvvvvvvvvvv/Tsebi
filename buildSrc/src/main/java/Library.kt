object Library {
    ...
    const val PAGE_INDICATOR = "ru.tinkoff.scrollingpagerindicator:scrollingpagerindicator:${Version.PAGE_INDICATOR}"
    ...
    const val DECORO = "ru.tinkoff.decoro:decoro:${Version.DECORO}"
    const val EASY_SNACKBAR = "com.sun.easysnackbar:easysnackbar:${Version.EASY_SNACKBAR}"

    const val TIMBER = "com.jakewharton.timber:timber:${Version.TIMBER}"

    const val LOCATION = "com.google.android.gms:play-services-location:${Version.LOCATION}"

    const val YANDEX_MAPS = "com.yandex.android:mapkit:${Version.YANDEX_MAPS}"

    const val GIF_DRAWABLE = "pl.droidsonroids.gif:android-gif-drawable:${Version.GIF_DRAWABLE}"
    ...
    const val YOUTUBE_PLAYER = "com.pierfrancescosoffritti.androidyoutubeplayer:core:${Version.YOUTUBE_PLAYER}"

    const val PHOTO_VIEW = "com.github.chrisbanes:PhotoView:${Version.PHOTO_VIEW}"
